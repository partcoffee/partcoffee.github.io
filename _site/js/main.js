...
$(function() {
  ...
  $('p').has('img').css('line-height', 0); /*! Because I can't be bothered to give every image a p
  class with line-height 0, or do a "nokramdown" thing. I should come back to this though. */
});
...
// Look at the viewport thing later. WIRED did it, and it was cool, but it was subtle
// Scrolling performance suffers in Chrome?
